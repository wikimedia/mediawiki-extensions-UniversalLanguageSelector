...
function useFloating(reference, floating, options) {
  ...
  const openOption = vue.computed(() => {
    var _unref;
    return (_unref = vue.unref(options.open)) != null ? _unref : true;
  });
  const middlewareOption = vue.computed(() => vue.unref(options.middleware));
  const placementOption = vue.computed(() => {
    var _unref2;
    return (_unref2 = vue.unref(options.placement)) != null ? _unref2 : 'bottom';
  });
  const strategyOption = vue.computed(() => {
    var _unref3;
    return (_unref3 = vue.unref(options.strategy)) != null ? _unref3 : 'absolute';
  });
  const transformOption = vue.computed(() => {
    var _unref4;
    return (_unref4 = vue.unref(options.transform)) != null ? _unref4 : true;
  });
